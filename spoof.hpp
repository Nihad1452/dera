...
void mouse_interface()
{
	...
	void* GetCursorPos = (void*)GetProcAddress(user32, "GetCursorPos");
	void* SetLayeredWindowAttributes = (void*)GetProcAddress(user32, "SetLayeredWindowAttributes");
	void* DwmExtendFrameIntoClientArea = (void*)GetProcAddress(dwmapi, "DwmExtendFrameIntoClientArea");
	void* DefWindowProcA = (void*)GetProcAddress(user32, "DefWindowProcA");
	void* CreateWindowExA = (void*)GetProcAddress(user32, "CreateWindowExA");
	void* SetWindowLongA = (void*)GetProcAddress(user32, "SetWindowLongA");
	void* GetWindowLongA = (void*)GetProcAddress(user32, "GetWindowLongA");
	void* RegisterClassExA = (void*)GetProcAddress(user32, "RegisterClassExA");
	void* GetSystemMetrics = (void*)GetProcAddress(user32, "GetSystemMetrics");
	void* FindWindowA = (void*)GetProcAddress(user32, "FindWindowA");
	void* GetAsyncKeyState = (void*)GetProcAddress(user32, "GetAsyncKeyState");
	void* GetForegroundWindow = (void*)GetProcAddress(user32, "GetForegroundWindow");
	void* MoveWindow = (void*)GetProcAddress(user32, "MoveWindow");
	void* PeekMessageA = (void*)GetProcAddress(user32, "PeekMessageA");
	void* TranslateMessage = (void*)GetProcAddress(user32, "TranslateMessage");
	void* DispatchMessageA = (void*)GetProcAddress(user32, "DispatchMessageA");
	void* CreateThread = (void*)GetProcAddress(kernel32, "CreateThread");
	void* SetWindowPos = (void*)GetProcAddress(user32, "SetWindowPos");
	void* CloseHandle = (void*)GetProcAddress(kernel32, "CloseHandle");
	void* ShowWindow = (void*)GetProcAddress(user32, "ShowWindow");
	void* SetWindowDisplayAffinity = (void*)GetProcAddress(user32, "SetWindowDisplayAffinity");
	void* mouzeevent = (void*)GetProcAddress(user32, "mouse_event");
	void* updetewindow = (void*)GetProcAddress(user32, "UpdateWindow");
	void* clientrect = (void*)GetProcAddress(user32, "GetClientRect");
	void* clienttoscreen = (void*)GetProcAddress(user32, "ClientToScreen");
